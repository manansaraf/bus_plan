 ...
 */
public class ExpandableListAdapterTripPlanner extends BaseExpandableListAdapter {
	...
	public ExpandableListAdapterTripPlanner(Context context, List<String> listDataHeader,
