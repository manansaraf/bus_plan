 ...
 */
public class CustomListAdapterTripPlanner extends BaseExpandableListAdapter {
	...
	public CustomListAdapterTripPlanner(Context context, List<String> listDataHeader,
