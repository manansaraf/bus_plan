...
import com.busplan.core_activities.DrawRouteActivity;
...
public class DrawRouteActivityTest extends ActivityInstrumentationTestCase2<DrawRouteActivity> {
	...
	public void testMap() {
		...
		drawRouteActivity.drawBusLocation(new LocationInfo(0.1, 0.1));
	...
	public void testBuildVehicleJSONFalse() {
		try {
			LocationInfo point = drawRouteActivity.buildVehicleJSON("{\"time\":\"2015-04-09T15:02:20-05:00\",\"new_changeset\":true,\"status\":{\"code\":404,\"msg\":\"Vehicle not found\"},\"rqst\":{\"params\":{}}}");
			assertNull(point);
		} catch (IOException e) {
			Log.e("TEST_ERROR", e.getMessage());
		}
